...
//baseURL = 'https://cool-tees-backend-production.herokuapp.com/';
// baseURL = 'https://masih-backend-production.herokuapp.com/';
...
///////////////////////////////////////////
    ...
    const getFavorites = async () => {
        const favorites = await api
            .get('/favorite/', { requireToken: true })
            .then(response => {
                return response.data;
            })
            .catch(error => {
     ...
     const addFavorites = async addFavoriteBody => {
        //{homeId: homeId} = {homeId}
        const savedPost = await api
            .post('/favorite/add/', addFavoriteBody, { requireToken: true })
            .then(response => {
                return response.data;
            })
            .catch(error => {
   ...
   const  deleteFavorites = id => {
        return api.delete(`/favorite/delete/${id}`, { requireToken: true });
    };
